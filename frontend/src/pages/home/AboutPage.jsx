      ...
      <div className="flex flex-col gap-8">
        ...
        <section className="text-center space-y-4">
          ...
          <p className="text-xl text-slate-400 italic">
            "A full-featured social media platform clone built with modern web
            technologies."
          </p>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-900 p-6 rounded-2xl border border-gray-700 shadow-xl">
            ...
            <p className="mt-4 text-slate-400 text-sm">
              Optimized for performance and scalability using the latest web
              standards.
            </p>
          </div>
        </section>
        ...
        <section className="bg-blue-900/20 p-8 rounded-2xl border border-blue-500/30 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 items-center">
            <div className="flex items-center gap-2 hover:text-primary transition-colors cursor-pointer">
              ...
              <span className="text-lg">support@mail.com</span>
            </div>
            <div className="flex items-center gap-2 hover:text-primary transition-colors cursor-pointer">
